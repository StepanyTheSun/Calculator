...
public class Main {
    ...
    public static void main (String[] args) {
        ...
        System.out.println("Введите выражение по типу [2+2] или два римских числа от I до X:[V+V] и нажмите Enter ");
    ...
    public static int calculated (int num1, int num2, char op) {
        ...
        if (number1 < 11 || number2 < 11) {
            ...
            System.out.println("ERROR... !!На ввод принимаются числа до 11!!");
            System.exit(1);
        }
                return result;
    }
